        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              {
                icon: (
                  <svg key="frontend" className="w-8 h-8 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
              ...
              {
                icon: (
                  <svg key="backend" className="w-8 h-8 text-green-500" fill="currentColor" viewBox="0 0 20 20">
              ...
              {
                icon: (
                  <svg key="database" className="w-8 h-8 text-purple-500" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" />
                  </svg>
                ),
                title: "Database",
              ...
              {
                icon: (
                  <svg key="tools" className="w-8 h-8 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                ),
              ...
              {
                icon: (
                  <svg key="mobile" className="w-8 h-8 text-red-500" fill="currentColor" viewBox="0 0 20 20">
