...
export const metadata: Metadata = {
  title: "About - Patrice Oyende | Full Stack Developer",
  description: "Learn about Patrice Oyende (Abelle Patrice), a Full Stack Developer specializing in React, React Native, Next.js, Python, and mobile app development. View projects, skills, and experience.",
  keywords: [
    "Patrice Oyende",
    "Abelle Patrice",
    "Abelle Patrice Oyende",
    "Oyende Patrice",
    "Patrice Abelle",
  ...
  openGraph: {
    title: "About - Patrice Oyende | Full Stack Developer",
    description: "Learn about Patrice Oyende (Abelle Patrice), a Full Stack Developer specializing in React, React Native, Next.js, Python, and mobile app development.",
    url: "https://portfolio-abelle-group.vercel.app/about",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Patrice Oyende - Full Stack Developer",
      },
    ],
    locale: "en_US",
    type: "profile",
  ...
  alternates: {
    canonical: "https://portfolio-abelle-group.vercel.app/about",
  },
};
...
//             {[
//               {
//                 title: "Ciineverxe - Movie App",
//                 desc: "Tech Stack: Next.js, TypeScript, Tailwind CSS. A modern movie discovery platform where users can browse trending movies, search for films, view detailed information including cast, ratings, and trailers. Features include favorites/watchlist, movie reviews, and similar movie recommendations. Live demo: ciineverxe.vercel.app. GitHub: github.com/abellepatrice/Ciineverxe.",
//               },
//               {
